...
var gondebeek_parcels = L.geoJson(JSON.parse('{{ gondebeek_parcels | escapejs }}'), {onEachFeature: onEachFeature});
var gondebeek_perimeter = L.geoJson(JSON.parse('{{ gondebeek_perimeter | escapejs }}'), {style: style_gondebeek_perimeter});

var map = L.map('map', {layers: [baselayer1]}).setView([50.97, 3.785], 15);
map.addLayer(gondebeek_parcels);

var overlays = {'Percelen': gondebeek_parcels, 'Perimeter': gondebeek_perimeter};
